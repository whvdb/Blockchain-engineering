...
Server Target Selection: A scheduled task (check_for_server) runs every 2.0 seconds, looping through discovered peers to match their public key against the hardcoded server public key: 4c69624e61434c504b3a86b23934a28d669c390e2d1fc0b0870706c4591cc0cb178bc5a811da6d87d27ef319b2638ef60cc8d119724f4c53a1ebfad919c3ac4136c501ce5c09364e0ebb
...
Note that besides having a _announce_block function that is called by a node to broadcast its new mined blocks (a push strategy), the sync_loop also incorporates a pull strategy, where a node selects another node every two seconds and asks for their current height to check if they have a longer chain. This is basically a safety net.
